...
*/
    ...
    //        OBSERVA��O: Existe um problema de logica onde as vezes a maoir e menor palavra s�o trocadas



    printf("\n1 - Leia um conjunto indeterminado de palavras e ao final (estipule voc� um flag) informe qual foi a maior palavra e a menor palavra digitada, em tamanho e lexicograficamente.\n");
...
int ex02(){
    ...
    */
    ...
    printf("\n2 � Ler um string e no m�ximo 50 caracteres e contar quantas letras A essa palavra possui.\n\n");


    char palavra [50];
    int numA, tam, i;

    printf("\nDigite uma string de no m�ximo 50 caracteres: \n");
...
int ex03(){
    /*
                                            ENTRADA                  SAIDA
                                            palavra                     A letra A na posi��o: 2
                                                                        A letra A na posi��o: 4
                                                                        A letra A na posi��o: 6

                                            banana                      A letra A na posi��o: 2
                                                                        A letra A na posi��o: 4
                                                                        A letra A na posi��o: 6
                                            string
    */
...
int ex04(){
    /*
                                            ENTRADA                  SAIDA
                                            banana n                    O caracter n na posi��o: 3
                                                                        O caracter n na posi��o: 5
                                                                        O caracter n apareceu 2 vezes

                                            banana b                    O caracter b na posi��o: 1
                                                                        O caracter b apareceu 1 vezes

                                            banana a                    O caracter a na posi��o: 2
                                                                        O caracter a na posi��o: 4
                                                                        O caracter a na posi��o: 6
                                                                        O caracter a apareceu 3 vezes
            */

    printf("\n4 �Ler uma string de no m�ximo 50 caracteres e em seguida um caractere, mostrar quais as posi��es esse caractere aparece na string lida e quantas vezes ele apareceu.\n\n");
    ...
    for(i = 0; i < tam; i++){
        if(strchr(caracter, palavra[i])!= NULL){
            numA++;
            printf("O caracter %s na posi��o: %i\n", caracter, i+1);
        }
    }
...
/*
                                            ...
                                            ENTRADA                  SAIDA
                                            banana N                    O caracter  na posi��o: 3
                                                                        O caracter  na posi��o: 5
                                                                        O caracter  apareceu 2 vezes

                                            Banana b                    O caracter  na posi��o: 1
                                                                        O caracter  apareceu 1 vezes

                                            banAnA a                    O caracter  na posi��o: 2
                                                                        O caracter  na posi��o: 4
                                                                        O caracter  na posi��o: 6
...
*/
    ...
    printf("\n5 - Ler uma stringde no m�ximo 50 caracteres e em seguida um caractere (entre A e z -consista se o caracteresta nesse intervalo), mostrar quais as posi��es esse caractere (mai�scula ou min�scula) na string lida e quantas vezes ele apareceu.\n");
...
*/
    printf("\n10 -Ler uma string de no m�ximo 50 caracteres em seguida leia outra string de no m�ximo 3 caracteres, informe quantas vezes a segunda string aparece na primeira string, e diga as posi��es iniciais em que ela aparece.\n");
    ...
    for(i = 0; i < tam; i++){
        ...
        if(strcmp(str2, aux) == 0){
            printf("\nA segunda string aparece na posi��o : %i\n",i +1);
            aux2++;
        }
